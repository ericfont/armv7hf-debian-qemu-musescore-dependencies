...
RUN apt-get install make automake gcc-4.7 g++-4.7 git cmake alsa-base libsndfile1 libasound2-dev portaudio19-dev libsndfile1-dev zlib1g-dev libfreetype6-dev libfreetype6 lame libmp3lame-dev libssl-dev libdrm-dev libgl1-mesa-dev libpulse-dev 
